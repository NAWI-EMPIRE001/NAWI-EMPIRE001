...
const PORT = parseInt(process.env.CULINARY_MATRIX_PORT || process.env.PORT || '10004', 10);
...
server.listen(PORT, () => {
  console.log(`🟢 CULINARY_MATRIX health endpoint listening on port ${PORT}`);
});
