...
const PORT = parseInt(process.env.SOVEREIGN_EXCHANGE_PORT || process.env.PORT || '10002', 10);
...
server.listen(PORT, () => {
  console.log(`🟢 SOVEREIGN_EXCHANGE health endpoint listening on port ${PORT}`);
});
