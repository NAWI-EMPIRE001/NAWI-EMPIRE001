...
const PORT = parseInt(process.env.DIAMONDBACK_FORGE_PORT || process.env.PORT || '10006', 10);
...
server.listen(PORT, () => {
  console.log(`🟢 DIAMONDBACK_FORGE health endpoint listening on port ${PORT}`);
});
